            ...
            <ion-list id="labels-list">
              ...
              <ion-item>
                ...
                >
                  ...
                  <ion-select-option value="darkPurple"
                    >Purple</ion-select-option
                  >
                  <ion-select-option value="darkDarkPurple"
                    >Deep Purple</ion-select-option
                  >
                  <ion-select-option value="darkIndigo"
                    >Indigo</ion-select-option
                  >
                  ...
                  <ion-select-option value="darkYellow"
                    >Yellow</ion-select-option
                  >
                  <ion-select-option value="darkAmber">Amber</ion-select-option>
                  <ion-select-option value="darkOrange"
                    >Orange</ion-select-option
                  >
